...
## 🎮 Game Playing
- StarCraft II
  - PySC2 [[API](https://github.com/BurnySc2/python-sc2)]
  - LLM-PySC2 [[API](https://github.com/NKAI-Decision-Team/LLM-PySC2)]
  ...
  - SwarmBrain: Embodied agent for real-time strategy game StarCraft II via large language models [[paper](https://arxiv.org/abs/2401.17749)] [[code]([https://github.com/histmeisah/Large-Language-Models-play-StarCraftII](https://github.com/ramsayxiaoshao/SwarmBrain))]
